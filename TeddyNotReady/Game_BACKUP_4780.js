...
=======
            bark.rotation = this.physics.arcade.moveToPointer(bark, 400, this.input.activePointer);
>>>>>>> origin/master
        }
    },
...
<<<<<<< HEAD
                ...
                head.kill();
=======
                    'gooddog', 'GAME OVER', 100);
                gameOverText.updateTransform();
                gameOverText.position.x = this.camera.x + 400 - gameOverText.textWidth / 2;
                gameOverText.position.y = this.camera.y + 300 - gameOverText.textHeight / 2;


                //text(this.camera.x + 100, this.camera.y + 250, "GAME OVER",
                    //{font: 'gooddog', fontSize: '100px', align: 'center'});
                player.kill();
                healthbar.kill();
>>>>>>> origin/master
